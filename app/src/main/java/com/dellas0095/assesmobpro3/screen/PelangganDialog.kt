        ...
        Card(
            ...
            Column (
                ...
                OutlinedTextField(
                    ...
                    label = { Text(text = stringResource(id = R.string.variant)) },
                    maxLines = 1,
                    keyboardOptions = KeyboardOptions(
                ...
                OutlinedTextField(
                    ...
                    label = { Text(text = stringResource(id = R.string.warna)) },
                    maxLines = 1,
                    keyboardOptions = KeyboardOptions(
                        capitalization = KeyboardCapitalization.Sentences,
                        imeAction = ImeAction.Done
                ...
                Row (
                    ...
                    OutlinedButton(
                        onClick = {onConfirmation(namaPelanggan, variant, warna)},
                        enabled = namaPelanggan.isNotEmpty()&& variant.isNotEmpty()&& warna.isNotEmpty(),
                        modifier = Modifier.padding(8.dp)
                    ) {
